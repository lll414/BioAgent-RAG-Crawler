---
source_url: https://satijalab.org/seurat/articles/seurat5_essential_commands
...
Source: [`vignettes/seurat5_essential_commands.Rmd`](https://github.com/satijalab/seurat/blob/HEAD/vignettes/seurat5_essential_commands.Rmd)

`seurat5_essential_commands.Rmd`

---

Here, we describe important commands and functions to store, access, and process data using Seurat v5. To demonstrate commamnds, we use a dataset of 3,000 PBMC (stored in-memory), and a dataset of 1.3M E18 mouse neurons (stored on-disk), which we constructed as described in the [BPCells vignette](/seurat/articles/seurat5_bpcells_interaction_vignette).
...
Prior to performing integration analysis in Seurat v5, we can split the layers into groups. The `IntegrateLayers` function, described in [our vignette](/seurat/articles/seurat5_integration), will then align shared cell types across these layers. After performing integration, you can rejoin the layers.
