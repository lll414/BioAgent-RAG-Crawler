---
source_url: https://r4ds.hadley.nz/arrow.html
download_date: 2025-11-20
---

1. [Import](./import.html)
2. [22  Arrow](./arrow.html)
...
There’s one last advantage of parquet and arrow — it’s very easy to turn an arrow dataset into a DuckDB database ([Chapter 21](databases.html)) by calling `arrow::to_duckdb()`:
