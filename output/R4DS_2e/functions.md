---
source_url: https://r4ds.hadley.nz/functions.html
download_date: 2025-11-20
---

1. [Program](./program.html)
2. [25  Functions](./functions.html)
...
(In [Chapter 26](iteration.html), you’ll learn how to use `across()` to reduce the duplication even further so all you need is `df |> mutate(across(a:d, rescale01))`).
...
To summarize multiple variables, you’ll need to wait until [Section 26.2](iteration.html#sec-across), where you’ll learn how to use `across()`.
...
![A histogram of carats of diamonds, ranging from 0 to 5, showing a unimodal,  right-skewed distribution with a peak between 0 to 1 carats.](functions_files/figure-html/unnamed-chunk-44-1.png)
...
![Scatterplot of height vs. mass of StarWars characters showing a positive  relationship. A smooth curve of the relationship is plotted in red, and  the best fit line is ploted in blue.](functions_files/figure-html/unnamed-chunk-46-1.png)
...
![Hex plot of price vs. carat of diamonds showing a positive relationship.  There are more diamonds that are less than 2 carats than more than 2 carats.](functions_files/figure-html/unnamed-chunk-47-1.png)
...
![Bar plot of clarify of diamonds, where clarity is on the y-axis and counts  are on the x-axis, and the bars are ordered in order of frequency: SI1,  VS2, SI2, VS1, VVS2, VVS1, IF, I1.](functions_files/figure-html/unnamed-chunk-48-1.png)
...
![Bar plot of clarity of diamonds. The most common is SI1, then SI2, then  VS2, then VS1, then VVS2, then VVS1, then I1, then lastly IF.](functions_files/figure-html/unnamed-chunk-49-1.png)
...
![Histogram of carats of diamonds, ranging from 0 to 5. The distribution is  unimodal and right skewed with a peak between 0 to 1 carats.](functions_files/figure-html/unnamed-chunk-51-1.png)
