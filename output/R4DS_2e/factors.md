---
source_url: https://r4ds.hadley.nz/factors.html
download_date: 2025-11-20
---

1. [Transform](./transform.html)
2. [16  Factors](./factors.html)
...
![A scatterplot of with tvhours on the x-axis and religion on the y-axis. The y-axis is ordered seemingly aribtrarily making it hard to get any sense of overall pattern.](factors_files/figure-html/unnamed-chunk-15-1.png)
...
![The same scatterplot as above, but now the religion is displayed in increasing order of tvhours. "Other eastern" has the fewest tvhours under 2, and "Don't know" has the highest (over 5).](factors_files/figure-html/unnamed-chunk-16-1.png)
...
![A scatterplot with age on the x-axis and income on the y-axis. Income has been reordered in order of average age which doesn't make much sense. One section of the y-axis goes from $6000-6999, then <$1000, then $8000-9999.](factors_files/figure-html/unnamed-chunk-18-1.png)
...
![The same scatterplot but now "Not Applicable" is displayed at the bottom of the y-axis. Generally there is a positive association between income and age, and the income band with the highethst average age is "Not applicable".](factors_files/figure-html/unnamed-chunk-19-1.png)
...
![A bar char of marital status ordered from least to most common: no answer (~0), separated (~1,000), widowed (~2,000), divorced (~3,000), never married (~5,000), married (~10,000).](factors_files/figure-html/unnamed-chunk-21-1.png)
...
1. They’re also really important for modelling.[↩︎](#fnref1)