...
Source URL: https://scikit-learn.org/stable/modules/classification_threshold.html
...
3.2. Tuning the hyper-parameters of an estimator](grid_search.html "previous page")
[next

3.4. Metrics and scoring: quantifying the quality of predictions](model_evaluation.html "next page")

On this page

* [3.3.1. Post-tuning the decision threshold](#post-tuning-the-decision-threshold)
  + [3.3.1.1. Options to tune the decision threshold](#options-to-tune-the-decision-threshold)
  + [3.3.1.2. Important notes regarding the internal cross-validation](#important-notes-regarding-the-internal-cross-validation)
  + [3.3.1.3. Manually setting the decision threshold](#manually-setting-the-decision-threshold)
  + [3.3.1.4. Examples](#examples)

### This Page

* [Show Source](../_sources/modules/classification_threshold.rst.txt)