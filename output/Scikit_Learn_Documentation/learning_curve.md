...
Source URL: https://scikit-learn.org/stable/modules/learning_curve.html
...
are as low as possible (see [Bias-variance dilemma](https://en.wikipedia.org/wiki/Bias-variance_dilemma)). Another way to reduce
...
## 3.5.1. Validation curve[#](#validation-curve "Link to this heading")

To validate a model we need a scoring function (see [Metrics and scoring: quantifying the quality of predictions](model_evaluation.html#model-evaluation)),
...
(see [Tuning the hyper-parameters of an estimator](grid_search.html#grid-search)) that select the hyperparameter with the maximum score
...
[`ValidationCurveDisplay`](generated/sklearn.model_selection.ValidationCurveDisplay.html#sklearn.model_selection.ValidationCurveDisplay "sklearn.model_selection.ValidationCurveDisplay") is more direct than
using matplotlib manually on the results of a call to [`validation_curve`](generated/sklearn.model_selection.validation_curve.html#sklearn.model_selection.validation_curve "sklearn.model_selection.validation_curve").
You can use the method
[`from_estimator`](generated/sklearn.model_selection.ValidationCurveDisplay.html#sklearn.model_selection.ValidationCurveDisplay.from_estimator "sklearn.model_selection.ValidationCurveDisplay.from_estimator") similarly
to [`validation_curve`](generated/sklearn.model_selection.validation_curve.html#sklearn.model_selection.validation_curve "sklearn.model_selection.validation_curve") to generate and plot the validation curve:
...
## 3.5.2. Learning curve[#](#learning-curve "Link to this heading")
...
We can use the function [`learning_curve`](generated/sklearn.model_selection.learning_curve.html#sklearn.model_selection.learning_curve "sklearn.model_selection.learning_curve") to generate the values
...
[`LearningCurveDisplay`](generated/sklearn.model_selection.LearningCurveDisplay.html#sklearn.model_selection.LearningCurveDisplay "sklearn.model_selection.LearningCurveDisplay") will be easier to use.
You can use the method
[`from_estimator`](generated/sklearn.model_selection.LearningCurveDisplay.html#sklearn.model_selection.LearningCurveDisplay.from_estimator "sklearn.model_selection.LearningCurveDisplay.from_estimator") similarly
to [`learning_curve`](generated/sklearn.model_selection.learning_curve.html#sklearn.model_selection.learning_curve "sklearn.model_selection.learning_curve") to generate and plot the learning curve:
...
* See [Plotting Learning Curves and Checking Models’ Scalability](../auto_examples/model_selection/plot_learning_curve.html#sphx-glr-auto-examples-model-selection-plot-learning-curve-py) for an
  example of using learning curves to check the scalability of a predictive model.

[previous

3.4. Metrics and scoring: quantifying the quality of predictions](model_evaluation.html "previous page")
[next

4. Metadata Routing](../metadata_routing.html "next page")

On this page

* [3.5.1. Validation curve](#validation-curve)
* [3.5.2. Learning curve](#learning-curve)

### This Page

* [Show Source](../_sources/modules/learning_curve.rst.txt)