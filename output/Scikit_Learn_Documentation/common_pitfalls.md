...
## 11.1. Inconsistent preprocessing[#](#inconsistent-preprocessing "Link to this heading")
...
Alternatively, we recommend using a [`Pipeline`](modules/generated/sklearn.pipeline.Pipeline.html#sklearn.pipeline.Pipeline "sklearn.pipeline.Pipeline"), which makes it easier to chain transformations
...
## 11.2. Data leakage[#](#data-leakage "Link to this heading")
...
### 11.2.1. How to avoid data leakage[#](#how-to-avoid-data-leakage "Link to this heading")
...
### 11.2.2. Data leakage during pre-processing[#](#data-leakage-during-pre-processing "Link to this heading")
...
[`StandardScaler`](modules/generated/sklearn.preprocessing.StandardScaler.html#sklearn.preprocessing.StandardScaler "sklearn.preprocessing.StandardScaler"),
[`SimpleImputer`](modules/generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer"), and
[`PCA`](modules/generated/sklearn.decomposition.PCA.html#sklearn.decomposition.PCA "sklearn.decomposition.PCA").
...
Here again, we recommend using a [`Pipeline`](modules/generated/sklearn.pipeline.Pipeline.html#sklearn.pipeline.Pipeline "sklearn.pipeline.Pipeline") to chain
...
function such as [`cross_val_score`](modules/generated/sklearn.model_selection.cross_val_score.html#sklearn.model_selection.cross_val_score "sklearn.model_selection.cross_val_score").
...
## 11.3. Controlling randomness[#](#controlling-randomness "Link to this heading")

Some scikit-learn objects are inherently random. These are usually estimators
(e.g. [`RandomForestClassifier`](modules/generated/sklearn.ensemble.RandomForestClassifier.html#sklearn.ensemble.RandomForestClassifier "sklearn.ensemble.RandomForestClassifier")) and cross-validation
splitters (e.g. [`KFold`](modules/generated/sklearn.model_selection.KFold.html#sklearn.model_selection.KFold "sklearn.model_selection.KFold")). The randomness of
these objects is controlled via their `random_state` parameter, as described
in the [Glossary](glossary.html#term-random_state). This section expands on the glossary
...
### 11.3.1. Using `None` or `RandomState` instances, and repeated calls to `fit` and `split`[#](#using-none-or-randomstate-instances-and-repeated-calls-to-fit-and-split "Link to this heading")

The `random_state` parameter determines whether multiple calls to [fit](glossary.html#term-fit)
(for estimators) or to [split](glossary.html#term-split) (for CV splitters) will produce the same
...
#### 11.3.1.1. Estimators[#](#estimators "Link to this heading")
...
[`SGDClassifier`](modules/generated/sklearn.linear_model.SGDClassifier.html#sklearn.linear_model.SGDClassifier "sklearn.linear_model.SGDClassifier"), we would have obtained the
...
#### 11.3.1.2. CV splitters[#](#cv-splitters "Link to this heading")
...
### 11.3.2. Common pitfalls and subtleties[#](#common-pitfalls-and-subtleties "Link to this heading")
...
#### 11.3.2.1. Estimators[#](#id2 "Link to this heading")
...
[`cross_val_score`](modules/generated/sklearn.model_selection.cross_val_score.html#sklearn.model_selection.cross_val_score "sklearn.model_selection.cross_val_score") **significantly differ in
each case**:
...
Here, [`cross_val_score`](modules/generated/sklearn.model_selection.cross_val_score.html#sklearn.model_selection.cross_val_score "sklearn.model_selection.cross_val_score") will use a
...
[`make_classification`](modules/generated/sklearn.datasets.make_classification.html#sklearn.datasets.make_classification "sklearn.datasets.make_classification") isn’t relevant for our
illustration purpose: what matters is what we pass to the
[`RandomForestClassifier`](modules/generated/sklearn.ensemble.RandomForestClassifier.html#sklearn.ensemble.RandomForestClassifier "sklearn.ensemble.RandomForestClassifier") estimator.

Cloning[#](#cloning "Link to this dropdown")

Another subtle side effect of passing `RandomState` instances is how
[`clone`](modules/generated/sklearn.base.clone.html#sklearn.base.clone "sklearn.base.clone") will work:
...
Even though [`clone`](modules/generated/sklearn.base.clone.html#sklearn.base.clone "sklearn.base.clone") is rarely used in user code, it is
...
[`clone`](modules/generated/sklearn.base.clone.html#sklearn.base.clone "sklearn.base.clone") internally
([`GridSearchCV`](modules/generated/sklearn.model_selection.GridSearchCV.html#sklearn.model_selection.GridSearchCV "sklearn.model_selection.GridSearchCV"),
[`StackingClassifier`](modules/generated/sklearn.ensemble.StackingClassifier.html#sklearn.ensemble.StackingClassifier "sklearn.ensemble.StackingClassifier"),
[`CalibratedClassifierCV`](modules/generated/sklearn.calibration.CalibratedClassifierCV.html#sklearn.calibration.CalibratedClassifierCV "sklearn.calibration.CalibratedClassifierCV"), etc.).

#### 11.3.2.2. CV splitters[#](#id3 "Link to this heading")
...
[`LinearDiscriminantAnalysis`](modules/generated/sklearn.discriminant_analysis.LinearDiscriminantAnalysis.html#sklearn.discriminant_analysis.LinearDiscriminantAnalysis "sklearn.discriminant_analysis.LinearDiscriminantAnalysis") estimator
vs the [`GaussianNB`](modules/generated/sklearn.naive_bayes.GaussianNB.html#sklearn.naive_bayes.GaussianNB "sklearn.naive_bayes.GaussianNB") estimator **on each fold** would
be a mistake: **the splits on which the estimators are evaluated are
different**. Indeed, [`cross_val_score`](modules/generated/sklearn.model_selection.cross_val_score.html#sklearn.model_selection.cross_val_score "sklearn.model_selection.cross_val_score") will
internally call `cv.split` on the same
[`KFold`](modules/generated/sklearn.model_selection.KFold.html#sklearn.model_selection.KFold "sklearn.model_selection.KFold") instance, but the splits will be
different each time. This is also true for any tool that performs model
selection via cross-validation, e.g.
[`GridSearchCV`](modules/generated/sklearn.model_selection.GridSearchCV.html#sklearn.model_selection.GridSearchCV "sklearn.model_selection.GridSearchCV") and
[`RandomizedSearchCV`](modules/generated/sklearn.model_selection.RandomizedSearchCV.html#sklearn.model_selection.RandomizedSearchCV "sklearn.model_selection.RandomizedSearchCV"): scores are not
...
[`KFold`](modules/generated/sklearn.model_selection.KFold.html#sklearn.model_selection.KFold "sklearn.model_selection.KFold"). Whether we pass a `RandomState`
instance or an integer to [`make_classification`](modules/generated/sklearn.datasets.make_classification.html#sklearn.datasets.make_classification "sklearn.datasets.make_classification")
is not relevant for our illustration purpose. Also, neither
[`LinearDiscriminantAnalysis`](modules/generated/sklearn.discriminant_analysis.LinearDiscriminantAnalysis.html#sklearn.discriminant_analysis.LinearDiscriminantAnalysis "sklearn.discriminant_analysis.LinearDiscriminantAnalysis") nor
[`GaussianNB`](modules/generated/sklearn.naive_bayes.GaussianNB.html#sklearn.naive_bayes.GaussianNB "sklearn.naive_bayes.GaussianNB") are randomized estimators.

### 11.3.3. General recommendations[#](#general-recommendations "Link to this heading")

#### 11.3.3.1. Getting reproducible results across multiple executions[#](#getting-reproducible-results-across-multiple-executions "Link to this heading")
...
`np.random.seed(0)`. See [here](https://stackoverflow.com/questions/5836335/consistently-create-same-random-numpy-array/5837352#comment6712034_5837352)
for a discussion.

#### 11.3.3.2. Robustness of cross-validation results[#](#robustness-of-cross-validation-results "Link to this heading")
...
initialization of an [`SGDClassifier`](modules/generated/sklearn.linear_model.SGDClassifier.html#sklearn.linear_model.SGDClassifier "sklearn.linear_model.SGDClassifier") to be
...
10. Model persistence](model_persistence.html "previous page")
[next

12. Dispatching](dispatching.html "next page")
...
* [11.3. Controlling randomness](#controlling-randomness)
  + [11.3.1. Using `None` or `RandomState` instances, and repeated calls to `fit` and `split`](#using-none-or-randomstate-instances-and-repeated-calls-to-fit-and-split)
    - [11.3.1.1. Estimators](#estimators)
    - [11.3.1.2. CV splitters](#cv-splitters)
  + [11.3.2. Common pitfalls and subtleties](#common-pitfalls-and-subtleties)
    - [11.3.2.1. Estimators](#id2)
    - [11.3.2.2. CV splitters](#id3)
  + [11.3.3. General recommendations](#general-recommendations)
    - [11.3.3.1. Getting reproducible results across multiple executions](#getting-reproducible-results-across-multiple-executions)
    - [11.3.3.2. Robustness of cross-validation results](#robustness-of-cross-validation-results)

### This Page

* [Show Source](_sources/common_pitfalls.rst.txt)