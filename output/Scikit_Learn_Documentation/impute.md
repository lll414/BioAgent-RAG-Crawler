...
Source URL: https://scikit-learn.org/stable/modules/impute.html
...
glossary entry on [imputation](../glossary.html#term-imputation).

## 7.4.1. Univariate vs. Multivariate Imputation[#](#univariate-vs-multivariate-imputation "Link to this heading")
...
(e.g. [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer")). By contrast, multivariate imputation
algorithms use the entire set of available feature dimensions to estimate the
missing values (e.g. [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer")).

## 7.4.2. Univariate feature imputation[#](#univariate-feature-imputation "Link to this heading")

The [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer") class provides basic strategies for imputing missing
...
The [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer") class also supports categorical data represented as
...
## 7.4.3. Multivariate feature imputation[#](#multivariate-feature-imputation "Link to this heading")

A more sophisticated approach is to use the [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") class,
...
the following issues would help stabilize [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer"):
convergence criteria ([#14338](https://github.com/scikit-learn/scikit-learn/issues/14338)) and default estimators
([#13286](https://github.com/scikit-learn/scikit-learn/issues/13286)). To use it, you need to explicitly import
...
Both [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer") and [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") can be used in a
Pipeline as a way to build a composite estimator that supports imputation.
See [Imputing missing values before building an estimator](../auto_examples/impute/plot_missing_values.html#sphx-glr-auto-examples-impute-plot-missing-values-py).

### 7.4.3.1. Flexibility of IterativeImputer[#](#flexibility-of-iterativeimputer "Link to this heading")
...
that can all be implemented with [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") by passing in
...
See [Imputing missing values with variants of IterativeImputer](../auto_examples/impute/plot_iterative_imputer_variants_comparison.html#sphx-glr-auto-examples-impute-plot-iterative-imputer-variants-comparison-py).

### 7.4.3.2. Multiple vs. Single Imputation[#](#multiple-vs-single-imputation "Link to this heading")
...
Our implementation of [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") was inspired by the R MICE
package (Multivariate Imputation by Chained Equations) [[1]](#id3), but differs from
it by returning a single imputation instead of multiple imputations. However,
[`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") can also be used for multiple imputations by applying
it repeatedly to the same dataset with different random seeds when
`sample_posterior=True`. See [[2]](#id4), chapter 4 for more discussion on multiple
...
Note that a call to the `transform` method of [`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") is
...
1-67.](https://www.jstatsoft.org/article/view/v045i03)
...
## 7.4.4. Nearest neighbors imputation[#](#nearest-neighbors-imputation "Link to this heading")

The [`KNNImputer`](generated/sklearn.impute.KNNImputer.html#sklearn.impute.KNNImputer "sklearn.impute.KNNImputer") class provides imputation for filling in missing values
using the k-Nearest Neighbors approach. By default, a euclidean distance metric
that supports missing values,
[`nan_euclidean_distances`](generated/sklearn.metrics.pairwise.nan_euclidean_distances.html#sklearn.metrics.pairwise.nan_euclidean_distances "sklearn.metrics.pairwise.nan_euclidean_distances"), is used to find the
...
Vol. 17 no. 6, 2001 Pages 520-525.](https://academic.oup.com/bioinformatics/article/17/6/520/272365)

## 7.4.5. Keeping the number of features constant[#](#keeping-the-number-of-features-constant "Link to this heading")
...
## 7.4.6. Marking imputed values[#](#marking-imputed-values "Link to this heading")

The [`MissingIndicator`](generated/sklearn.impute.MissingIndicator.html#sklearn.impute.MissingIndicator "sklearn.impute.MissingIndicator") transformer is useful to transform a dataset into
...
missing can be informative. Note that both the [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer") and
[`IterativeImputer`](generated/sklearn.impute.IterativeImputer.html#sklearn.impute.IterativeImputer "sklearn.impute.IterativeImputer") have the boolean parameter `add_indicator`
(`False` by default) which when set to `True` provides a convenient way of
stacking the output of the [`MissingIndicator`](generated/sklearn.impute.MissingIndicator.html#sklearn.impute.MissingIndicator "sklearn.impute.MissingIndicator") transformer with the
...
When using the [`MissingIndicator`](generated/sklearn.impute.MissingIndicator.html#sklearn.impute.MissingIndicator "sklearn.impute.MissingIndicator") in a
[`Pipeline`](generated/sklearn.pipeline.Pipeline.html#sklearn.pipeline.Pipeline "sklearn.pipeline.Pipeline"), be sure to use the
[`FeatureUnion`](generated/sklearn.pipeline.FeatureUnion.html#sklearn.pipeline.FeatureUnion "sklearn.pipeline.FeatureUnion") or
[`ColumnTransformer`](generated/sklearn.compose.ColumnTransformer.html#sklearn.compose.ColumnTransformer "sklearn.compose.ColumnTransformer") to add the indicator features to
...
Now we create a [`FeatureUnion`](generated/sklearn.pipeline.FeatureUnion.html#sklearn.pipeline.FeatureUnion "sklearn.pipeline.FeatureUnion"). All features will be
imputed using [`SimpleImputer`](generated/sklearn.impute.SimpleImputer.html#sklearn.impute.SimpleImputer "sklearn.impute.SimpleImputer"), in order to enable classifiers to work
with this data. Additionally, it adds the indicator variables from
[`MissingIndicator`](generated/sklearn.impute.MissingIndicator.html#sklearn.impute.MissingIndicator "sklearn.impute.MissingIndicator").
...
wrap this in a [`Pipeline`](generated/sklearn.pipeline.Pipeline.html#sklearn.pipeline.Pipeline "sklearn.pipeline.Pipeline") with a classifier (e.g., a
[`DecisionTreeClassifier`](generated/sklearn.tree.DecisionTreeClassifier.html#sklearn.tree.DecisionTreeClassifier "sklearn.tree.DecisionTreeClassifier")) to be able to make predictions.
...
## 7.4.7. Estimators that handle NaN values[#](#estimators-that-handle-nan-values "Link to this heading")
...
7.3. Preprocessing data](preprocessing.html "previous page")
[next

7.5. Unsupervised dimensionality reduction](unsupervised_reduction.html "next page")

On this page

* [7.4.1. Univariate vs. Multivariate Imputation](#univariate-vs-multivariate-imputation)
* [7.4.2. Univariate feature imputation](#univariate-feature-imputation)
* [7.4.3. Multivariate feature imputation](#multivariate-feature-imputation)
  + [7.4.3.1. Flexibility of IterativeImputer](#flexibility-of-iterativeimputer)
  + [7.4.3.2. Multiple vs. Single Imputation](#multiple-vs-single-imputation)
* [7.4.4. Nearest neighbors imputation](#nearest-neighbors-imputation)
* [7.4.5. Keeping the number of features constant](#keeping-the-number-of-features-constant)
* [7.4.6. Marking imputed values](#marking-imputed-values)
* [7.4.7. Estimators that handle NaN values](#estimators-that-handle-nan-values)

### This Page

* [Show Source](../_sources/modules/impute.rst.txt)