...
Source URL: https://scikit-learn.org/stable/computing/parallelism.html
...
## 9.3.1. Parallelism[#](#parallelism "Link to this heading")
...
### 9.3.1.1. Higher-level parallelism with joblib[#](#higher-level-parallelism-with-joblib "Link to this heading")
...
Please help us by improving our docs and tackle [issue 14228](https://github.com/scikit-learn/scikit-learn/issues/14228)!
...
(which isn’t reasonable with big datasets), joblib will create a [memmap](https://docs.scipy.org/doc/numpy/reference/generated/numpy.memmap.html)
...
Please refer to the [joblib’s docs](https://joblib.readthedocs.io/en/latest/parallel.html#thread-based-parallelism-vs-process-based-parallelism)
for more details.
...
estimators or functions in parallel (see [oversubscription](#oversubscription) below).

### 9.3.1.2. Lower-level parallelism with OpenMP[#](#lower-level-parallelism-with-openmp "Link to this heading")
...
### 9.3.1.3. Parallel NumPy and SciPy routines from numerical libraries[#](#parallel-numpy-and-scipy-routines-from-numerical-libraries "Link to this heading")
...
### 9.3.1.4. Oversubscription: spawning too many threads[#](#oversubscription-spawning-too-many-threads "Link to this heading")
...
a [`GridSearchCV`](../modules/generated/sklearn.model_selection.GridSearchCV.html#sklearn.model_selection.GridSearchCV "sklearn.model_selection.GridSearchCV") (parallelized with joblib)
with `n_jobs=8` over a
[`HistGradientBoostingClassifier`](../modules/generated/sklearn.ensemble.HistGradientBoostingClassifier.html#sklearn.ensemble.HistGradientBoostingClassifier "sklearn.ensemble.HistGradientBoostingClassifier") (parallelized with
OpenMP). Each instance of
[`HistGradientBoostingClassifier`](../modules/generated/sklearn.ensemble.HistGradientBoostingClassifier.html#sklearn.ensemble.HistGradientBoostingClassifier "sklearn.ensemble.HistGradientBoostingClassifier") will spawn 8 threads
...
[`GridSearchCV`](../modules/generated/sklearn.model_selection.GridSearchCV.html#sklearn.model_selection.GridSearchCV "sklearn.model_selection.GridSearchCV") is `loky`, each process will
...
in [joblib documentation](https://joblib.readthedocs.io/en/latest/parallel.html#avoiding-over-subscription-of-cpu-resources).

You will find additional details about parallelism in numerical python libraries
in [this document from Thomas J. Fan](https://thomasjpfan.github.io/parallelism-python-libraries-design/).

## 9.3.2. Configuration switches[#](#configuration-switches "Link to this heading")

### 9.3.2.1. Python API[#](#python-api "Link to this heading")

[`sklearn.set_config`](../modules/generated/sklearn.set_config.html#sklearn.set_config "sklearn.set_config") and [`sklearn.config_context`](../modules/generated/sklearn.config_context.html#sklearn.config_context "sklearn.config_context") can be used to change
parameters of the configuration which control aspect of parallelism.

### 9.3.2.2. Environment variables[#](#environment-variables "Link to this heading")

These environment variables should be set before importing scikit-learn.

#### 9.3.2.2.1. `SKLEARN_ASSUME_FINITE`[#](#sklearn-assume-finite "Link to this heading")

Sets the default value for the `assume_finite` argument of
[`sklearn.set_config`](../modules/generated/sklearn.set_config.html#sklearn.set_config "sklearn.set_config").

#### 9.3.2.2.2. `SKLEARN_WORKING_MEMORY`[#](#sklearn-working-memory "Link to this heading")

Sets the default value for the `working_memory` argument of
[`sklearn.set_config`](../modules/generated/sklearn.set_config.html#sklearn.set_config "sklearn.set_config").

#### 9.3.2.2.3. `SKLEARN_SEED`[#](#sklearn-seed "Link to this heading")
...
#### 9.3.2.2.4. `SKLEARN_TESTS_GLOBAL_RANDOM_SEED`[#](#sklearn-tests-global-random-seed "Link to this heading")
...
#### 9.3.2.2.5. `SKLEARN_SKIP_NETWORK_TESTS`[#](#sklearn-skip-network-tests "Link to this heading")
...
#### 9.3.2.2.6. `SKLEARN_RUN_FLOAT32_TESTS`[#](#sklearn-run-float32-tests "Link to this heading")
...
#### 9.3.2.2.7. `SKLEARN_ENABLE_DEBUG_CYTHON_DIRECTIVES`[#](#sklearn-enable-debug-cython-directives "Link to this heading")
...
#### 9.3.2.2.8. `SKLEARN_BUILD_ENABLE_DEBUG_SYMBOLS`[#](#sklearn-build-enable-debug-symbols "Link to this heading")
...
#### 9.3.2.2.9. `SKLEARN_PAIRWISE_DIST_CHUNK_SIZE`[#](#sklearn-pairwise-dist-chunk-size "Link to this heading")
...
#### 9.3.2.2.10. `SKLEARN_WARNINGS_AS_ERRORS`[#](#sklearn-warnings-as-errors "Link to this heading")
...
9.2. Computational Performance](computational_performance.html "previous page")
[next

10. Model persistence](../model_persistence.html "next page")

On this page

* [9.3.1. Parallelism](#parallelism)
  + [9.3.1.1. Higher-level parallelism with joblib](#higher-level-parallelism-with-joblib)
  + [9.3.1.2. Lower-level parallelism with OpenMP](#lower-level-parallelism-with-openmp)
  + [9.3.1.3. Parallel NumPy and SciPy routines from numerical libraries](#parallel-numpy-and-scipy-routines-from-numerical-libraries)
  + [9.3.1.4. Oversubscription: spawning too many threads](#oversubscription-spawning-too-many-threads)
* [9.3.2. Configuration switches](#configuration-switches)
  + [9.3.2.1. Python API](#python-api)
  + [9.3.2.2. Environment variables](#environment-variables)
    - [9.3.2.2.1. `SKLEARN_ASSUME_FINITE`](#sklearn-assume-finite)
    - [9.3.2.2.2. `SKLEARN_WORKING_MEMORY`](#sklearn-working-memory)
    - [9.3.2.2.3. `SKLEARN_SEED`](#sklearn-seed)
    - [9.3.2.2.4. `SKLEARN_TESTS_GLOBAL_RANDOM_SEED`](#sklearn-tests-global-random-seed)
    - [9.3.2.2.5. `SKLEARN_SKIP_NETWORK_TESTS`](#sklearn-skip-network-tests)
    - [9.3.2.2.6. `SKLEARN_RUN_FLOAT32_TESTS`](#sklearn-run-float32-tests)
    - [9.3.2.2.7. `SKLEARN_ENABLE_DEBUG_CYTHON_DIRECTIVES`](#sklearn-enable-debug-cython-directives)
    - [9.3.2.2.8. `SKLEARN_BUILD_ENABLE_DEBUG_SYMBOLS`](#sklearn-build-enable-debug-symbols)
    - [9.3.2.2.9. `SKLEARN_PAIRWISE_DIST_CHUNK_SIZE`](#sklearn-pairwise-dist-chunk-size)
    - [9.3.2.2.10. `SKLEARN_WARNINGS_AS_ERRORS`](#sklearn-warnings-as-errors)

### This Page

* [Show Source](../_sources/computing/parallelism.rst.txt)