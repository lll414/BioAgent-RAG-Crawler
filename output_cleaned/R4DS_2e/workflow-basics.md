---
source_url: https://r4ds.hadley.nz/workflow-basics.html
download_date: 2025-11-20
---

1. [Whole game](./whole-game.html)
2. [2  Workflow: basics](./workflow-basics.html)
...
We’ll return to names again when we discuss code style in [Chapter 4](workflow-style.html).
...
![Environment tab of RStudio which shows r_rocks, this_is_a_really_long_name,  x, and y in the Global Environment.](screenshots/rstudio-env.png)
...
4. Let’s revisit an exercise from the [Section 1.6](data-visualize.html#sec-ggsave). Run the following lines of code. Which of the two plots is saved as `mpg-plot.png`? Why?
