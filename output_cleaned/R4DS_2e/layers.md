---
source_url: https://r4ds.hadley.nz/layers.html
download_date: 2025-11-20
---

1. [Visualize](./visualize.html)
2. [9  Layers](./layers.html)

# 9  Layers

## 9.1 Introduction

In [Chapter 1](data-visualize.html), you learned much more than just how to make scatterplots, bar charts, and boxplots. You learned a foundation that you can use to make *any* type of plot with ggplot2.
...
![Scatterplot of highway fuel efficiency versus engine size of cars  that shows a negative association. All points are blue.](layers_files/figure-html/unnamed-chunk-5-1.png)
...
* The shape of a point as a number, e.g, `shape = 1`, as shown in [Figure 9.1](#fig-shapes).

![Mapping between shapes and the numbers that represent them: 0 - square open,  1 - circle open, 2 - triangle open, 3 - plus, 4 - cross, 5 - diamond open,  6 - triangle down open, 7 - square cross, 8 - asterisk, 9 - diamond plus,  10 - circle plus, 11 - star, 12 - square plus,  13 - circle cross, 14 - square triangle, 15 - square,  16 - circle small, 17 - triangle, 18 - diamond,  19 - circle, 20 - bullet, 21 - circle filled,  22 - square filled, 23 - diamond filled, 24 - triangle filled,  25 - triangle down filled.](layers_files/figure-html/fig-shapes-1.png)
...
![There are two plots. The plot on the left is a scatterplot of highway  fuel efficiency versus engine size of cars and the plot on the right  shows a smooth curve that follows the trajectory of the relationship  between these variables. A confidence interval around the smooth  curve is also displayed.](layers_files/figure-html/unnamed-chunk-7-1.png)

![There are two plots. The plot on the left is a scatterplot of highway  fuel efficiency versus engine size of cars and the plot on the right  shows a smooth curve that follows the trajectory of the relationship  between these variables. A confidence interval around the smooth  curve is also displayed.](layers_files/figure-html/unnamed-chunk-7-2.png)
...
![Two plots of highway fuel efficiency versus engine size of cars. The data are represented with smooth curves. On the left, three  smooth curves, all with the same linetype. On the right, three  smooth curves with different line types (solid, dashed, or long  dashed) for each type of drive train. In both plots, confidence  intervals around the smooth curves are also displayed.](layers_files/figure-html/unnamed-chunk-9-1.png)

![Two plots of highway fuel efficiency versus engine size of cars. The data are represented with smooth curves. On the left, three  smooth curves, all with the same linetype. On the right, three  smooth curves with different line types (solid, dashed, or long  dashed) for each type of drive train. In both plots, confidence  intervals around the smooth curves are also displayed.](layers_files/figure-html/unnamed-chunk-9-2.png)
...
![A plot of highway fuel efficiency versus engine size of cars. The data  are represented with points (colored by drive train) as well as smooth  curves (where line type is determined based on drive train as well).  Confidence intervals around the smooth curves are also displayed.](layers_files/figure-html/unnamed-chunk-10-1.png)
...
![Three plots, each with highway fuel efficiency on the y-axis and engine  size of cars on the x-axis, where data are represented by a smooth curve. The first plot  only has these two variables, the center plot has three separate smooth  curves for each level of drive train, and the right plot not only has the  same three separate smooth curves for each level of drive train but these  curves are plotted in different colors.  Confidence intervals around the smooth curves  are also displayed.](layers_files/figure-html/unnamed-chunk-11-1.png)

![Three plots, each with highway fuel efficiency on the y-axis and engine  size of cars on the x-axis, where data are represented by a smooth curve. The first plot  only has these two variables, the center plot has three separate smooth  curves for each level of drive train, and the right plot not only has the  same three separate smooth curves for each level of drive train but these  curves are plotted in different colors.  Confidence intervals around the smooth curves  are also displayed.](layers_files/figure-html/unnamed-chunk-11-2.png)

![Three plots, each with highway fuel efficiency on the y-axis and engine  size of cars on the x-axis, where data are represented by a smooth curve. The first plot  only has these two variables, the center plot has three separate smooth  curves for each level of drive train, and the right plot not only has the  same three separate smooth curves for each level of drive train but these  curves are plotted in different colors.  Confidence intervals around the smooth curves  are also displayed.](layers_files/figure-html/unnamed-chunk-11-3.png)
...
![Scatterplot of highway fuel efficiency versus engine size of cars, where  two-seater cars are highlighted with red points and open circles. ](layers_files/figure-html/unnamed-chunk-13-1.png)
...
![Three plots: histogram, density plot, and box plot of highway mileage.](layers_files/figure-html/unnamed-chunk-14-1.png)

![Three plots: histogram, density plot, and box plot of highway mileage.](layers_files/figure-html/unnamed-chunk-14-2.png)

![Three plots: histogram, density plot, and box plot of highway mileage.](layers_files/figure-html/unnamed-chunk-14-3.png)
...
![Density curves for highway mileage for cars with rear wheel, front wheel, and 4-wheel drives plotted separately. The distribution is bimodal and roughly symmetric for real and 4 wheel drive cars and unimodal and right skewed for front wheel drive cars.](layers_files/figure-html/unnamed-chunk-15-1.png)
...
![Scatterplot of highway fuel efficiency versus engine size of cars,  faceted by number of cylinders, with facets spanning two rows.](layers_files/figure-html/unnamed-chunk-18-1.png)
...
![Scatterplot of highway fuel efficiency versus engine size of cars, faceted  by number of cylinders across rows and by type of drive train across  columns. This results in a 4x3 grid of 12 facets. Some of these facets have  no observations: 5 cylinders and 4 wheel drive, 4 or 5 cylinders and front  wheel drive.](layers_files/figure-html/unnamed-chunk-19-1.png)
...
![Bar chart of number of each cut of diamond. There are roughly 1500  Fair, 5000 Good, 12000 Very Good, 14000 Premium, and 22000 Ideal cut  diamonds.](layers_files/figure-html/unnamed-chunk-26-1.png)
...
The algorithm used to calculate new values for a graph is called a **stat**, short for statistical transformation. [Figure 9.2](#fig-vis-stat-bar) shows how this process works with `geom_bar()`.
...
1. You might want to override the default stat. In the code below, we change the stat of `geom_bar()` from count (the default) to identity. This lets us map the height of the bars to the raw values of a y variable.
   ...
   ![Bar chart of number of each cut of diamond. There are roughly 1500  Fair, 5000 Good, 12000 Very Good, 14000 Premium, and 22000 Ideal cut  diamonds.](layers_files/figure-html/unnamed-chunk-27-1.png)
2. You might want to override the default mapping from transformed variables to aesthetics. For example, you might want to display a bar chart of proportions, rather than counts:
   ...
   ![Bar chart of proportion of each cut of diamond. Roughly, Fair  diamonds make up 0.03, Good 0.09, Very Good 0.22, Premium 0.26, and  Ideal 0.40.](layers_files/figure-html/unnamed-chunk-28-1.png)
...
3. You might want to draw greater attention to the statistical transformation in your code. For example, you might use `stat_summary()`, which summarizes the y values for each unique x value, to draw attention to the summary that you’re computing:
   ...
   ![A plot with depth on the y-axis and cut on the x-axis (with levels  fair, good, very good, premium, and ideal) of diamonds. For each level  of cut, vertical lines extend from minimum to maximum depth for diamonds  in that cut category, and the median depth is indicated on the line  with a point.](layers_files/figure-html/unnamed-chunk-29-1.png)
...
![Two bar charts of drive types of cars. In the first plot, the bars have  colored borders. In the second plot, they're filled with colors. Heights  of the bars correspond to the number of cars in each drv category.](layers_files/figure-html/unnamed-chunk-31-1.png)

![Two bar charts of drive types of cars. In the first plot, the bars have  colored borders. In the second plot, they're filled with colors. Heights  of the bars correspond to the number of cars in each drv category.](layers_files/figure-html/unnamed-chunk-31-2.png)
...
* `position = "identity"` will place each object exactly where it falls in the context of the graph. This is not very useful for bars, because it overlaps them. To see that overlapping we either need to make the bars slightly transparent by setting `alpha` to a small value, or completely transparent by setting `fill = NA`.
  ...
  ![Segmented bar chart of drive types of cars, where each bar is filled with  colors for the classes of cars.  Heights of the colored  segments represent the number of cars with a given class  level within a given drive type level. However the segments overlap. In  the first plot the bars are filled with transparent colors and in the second plot they are only outlined with color.](layers_files/figure-html/unnamed-chunk-33-1.png)

  ![Segmented bar chart of drive types of cars, where each bar is filled with  colors for the classes of cars.  Heights of the colored  segments represent the number of cars with a given class  level within a given drive type level. However the segments overlap. In  the first plot the bars are filled with transparent colors and in the second plot they are only outlined with color.](layers_files/figure-html/unnamed-chunk-33-2.png)
...
![Scatterplot of highway fuel efficiency versus engine size of cars that  shows a negative association.](layers_files/figure-html/unnamed-chunk-35-1.png)
...
![Jittered scatterplot of highway fuel efficiency versus engine size of cars.  The plot shows a negative association.](layers_files/figure-html/unnamed-chunk-36-1.png)
...
* `coord_quickmap()` sets the aspect ratio correctly for geographic maps. This is very important if you’re plotting spatial data with ggplot2. We don’t have the space to discuss maps in this book, but you can learn more in the [Maps chapter](https://ggplot2-book.org/maps.html) of *ggplot2: Elegant graphics for data analysis*.
  ...
  ![Two maps of the boundaries of New Zealand. In the first plot the aspect  ratio is incorrect, in the second plot it is correct.](layers_files/figure-html/unnamed-chunk-39-1.png)

  ![Two maps of the boundaries of New Zealand. In the first plot the aspect  ratio is incorrect, in the second plot it is correct.](layers_files/figure-html/unnamed-chunk-39-2.png)
* `coord_polar()` uses polar coordinates. Polar coordinates reveal an interesting connection between a bar chart and a Coxcomb chart.
  ...
  ![There are two plots. On the left is a bar chart of clarity of diamonds,  on the right is a Coxcomb chart of the same data.](layers_files/figure-html/unnamed-chunk-40-1.png)

  ![There are two plots. On the left is a bar chart of clarity of diamonds,  on the right is a Coxcomb chart of the same data.](layers_files/figure-html/unnamed-chunk-40-2.png)
...
We can expand on the graphing template you learned in [Section 1.3](data-visualize.html#sec-ggplot2-calls) by adding position adjustments, stats, coordinate systems, and faceting:
