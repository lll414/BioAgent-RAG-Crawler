Source URL: https://bioconductor.org/books/release/OHCA/pages/principles.html
Date Scraped: 2025-12-15

---

1. [Fundamentals concepts](https://bioconductor.org/books/release/OHCA/pages/principles.html)
2. [1  Hi-C pre-processing steps](https://bioconductor.org/books/release/OHCA/pages/principles.html)
...
The Hi-C procedure (Lieberman-Aiden et al. ([2009](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Lieberman_Aiden_2009))) stems from the clever combination of high-throughput sequencing and Chromatin Conformation Capture (3C) experimental approach (Dekker et al. ([2002](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Dekker_2002))).  
...
A number of C variants have been proposed since the publication of the original 3C method (reviewed by Davies et al. ([2017](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Davies_2017))), the main ones being Capture-C and ChIA-PET (see procedure below).

![](images/20230221172531.png)

Capture-C is useful to quantify interactions between a set of regulatory elements of interest. ChIA-PET, on the other hand, can identify interactions mediated by a specific protein of interest. Finally, an increasing number of Hi-C approaches rely on long-read sequencing (e.g. Deshpande et al. ([2022](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Deshpande_2022)), Tavares-Cadete et al. ([2020](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Tavares_Cadete_2020))) to identify clusters of 3D contacts.
...
We will now describe the structure of these different types of files. Directly jump to the [next chapter](https://bioconductor.org/books/release/OHCA/pages/data-representation.html) if you want to know more about importing data from a contact matrix or a pairs file in R.
...
The HiC-Pro pipeline (Servant et al. ([2015](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Servant_2015))) outputs 2 text files: a `regions.bed` file and a `count.matrix` file. They are generated by the exact process explained above.
...
The `.cool` format has been formally defined in Abdennur & Mirny ([2019](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Abdennur_2019)) and is a particular type of `HDF5` (`Hierarchical Data Format`) file. It is an indexed archive file storing rectangular tables called:
...
The `.hic` format is another type of binarized, indexed and highly-compressed file (Durand et al. ([2016](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Durand_2016))). It can store virtually the same information than a `.cool` file. However, parsing `.hic` files is not as straightforward as `.cool` files, as it does not rely on a generic file standard. Still, the `straw` library has been implemented in several computing languages to facilitate parsing of `.hic` files (Durand et al. ([2016](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Durand_2016))).
...
In practice, a minimal workflow to pre-process Hi-C data is the following (adapted from Open2C et al. ([2023](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Open2C_2023))):
...
* `HiC-pro` (Servant et al. ([2015](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Servant_2015)))
* `Juicer` (Durand et al. ([2016](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Durand_2016)))

Note

For larger genomes (> 1Gb) with more than few tens of M of reads per fastq (e.g. > 100M), we recommend pre-processing data on an HPC cluster. Aligners, pairs processing and matrix binning can greatly benefit from parallelization over multiple CPUs (Open2C et al. ([2023](https://bioconductor.org/books/release/OHCA/pages/principles.html#ref-Open2C_2023)))).  
...
r1
##                                                        EH7783 
##  "/home/biocbuild/.cache/R/ExperimentHub/15c427129b3999_7833"

r2
##                                                        EH7784 
##  "/home/biocbuild/.cache/R/ExperimentHub/15c427540af966_7834"
```
