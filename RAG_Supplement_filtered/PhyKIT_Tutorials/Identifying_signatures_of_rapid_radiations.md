# Identifying signatures of rapid radiations
...
([Sayyari and Mirarab 2018](https://www.mdpi.com/2073-4425/9/3/132);
[One Thousand Plant Transcriptomes Initiative 2019](https://www.nature.com/articles/s41586-019-1693-2);
...
**Download test data:
[`polytomy_tutorial.tar.gz`](../_downloads/825af78eae72758221fb88615fc165e6/polytomy_tutorial.tar.gz)**

### Step 0: Prepare data[](#id16 "Link to this heading")
...
taxa, separate each tip name using a semi-colon ‘;’. For example, in *groups\_file0.txt* there is one group with *Aspergillus\_persii;Aspergillus\_sclerotiorum*
wherein this group has two taxa, *Aspergillus\_persii* and *Aspergillus\_sclerotiorum*.
...
### Step 1: Conduct polytomy test[](#step-1-conduct-polytomy-test "Link to this heading")

Among the groups that have already been predetermined for the user, we will first conduct a polytomy test for *groups\_file0.txt*. To
...
*Note,* if you are getting an error, it may be due to improper pathing in *filamentous\_fungi\_250\_trees.txt.* Please check this file and
