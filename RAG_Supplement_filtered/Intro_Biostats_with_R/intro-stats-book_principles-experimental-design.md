Source URL: https://tuos-bio-data-skills.github.io/intro-stats-book/principles-experimental-design.html
...
2. Take steps to minimise the variability in the data[13](#fn13).
...
2. Each treatment should occur at least once within each block[14](#fn14).
...
Here, A1 denotes the first randomly chosen animal from litter A, A2 denotes the second randomly chosen animal from litter A, and A3 denotes the third randomly chosen animal from litter A. Blocking the design like this is guaranteed to increase the power of the experiment to detect effects of the treatments when there are differences between litters.
...
12. It is worth noting that in reports *experiment* and *observation* should always be distinguished. If we have carried out observations on a natural system of any sort, but where there has been no experimental manipulation of any aspect of the system, that is not an experiment. It would be inappropriate to write in a report: “This experiment consisted of measuring mean stomatal density from thirty trees growing at a range of altitudes.” Instead, we might write: “We conducted an observational study measuring mean stomatal density from thirty trees growing at a range of altitudes.”[↩︎](principles-experimental-design.html#fnref12)
13. This variability could be due to all kinds of things: the organisms/material being used; of the experimental conditions; and of the methods of measurement.[↩︎](principles-experimental-design.html#fnref13)
14. Actually, there are special types of experimental design that use blocking, but where each treatment does not appear in every block. These are much more advanced than anything we will cover in this book.[↩︎](principles-experimental-design.html#fnref14)