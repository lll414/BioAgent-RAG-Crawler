Source URL: https://tuos-bio-data-skills.github.io/intro-stats-book/hypotheses-and-p-values.html
Date Scraped: 2025-12-12

---

# Chapter 7 Hypotheses and *p*-values

![Significant: [xkcd.com](https://xkcd.com/882)](images/significant_xkcd.png)

Figure 7.1: Significant: [xkcd.com](https://xkcd.com/882)

## 7.1 A few words about the null hypothesis
...
### 7.1.1 Hypotheses and null hypotheses

When discussing [the scientific process](scientific-process.html#stages-hypotheses), we said that an hypothesis is a statement of a proposed process or mechanism responsible for an observed pattern or effect. We have also seen that in statistics, we encounter ‘hypothesis’ used differently. In particular, we often see **null hypotheses** (often written in statistics books as H0).
...
#### A *p*-value is not an evidence summary
...
### 7.1.2 Report the null hypothesis?
...
## 7.2 Interpreting and reporting *p*-values
...
### 7.2.1 Careful with those *p*-values
...
## 7.3 Biological vs. statistical significance
