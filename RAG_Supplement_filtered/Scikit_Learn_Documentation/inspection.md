...
Source URL: https://scikit-learn.org/stable/inspection.html
...
[`sklearn.inspection`](api/sklearn.inspection.html#module-sklearn.inspection "sklearn.inspection") module provides tools to help understand the
...
4. Metadata Routing](metadata_routing.html "previous page")
[next

5.1. Partial Dependence and Individual Conditional Expectation plots](modules/partial_dependence.html "next page")

### This Page

* [Show Source](_sources/inspection.rst.txt)