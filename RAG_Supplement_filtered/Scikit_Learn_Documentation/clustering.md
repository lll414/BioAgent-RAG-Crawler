...
Source URL: https://scikit-learn.org/stable/modules/clustering.html
...
These can be obtained from the classes in the [`sklearn.feature_extraction`](../api/sklearn.feature_extraction.html#module-sklearn.feature_extraction "sklearn.feature_extraction")
module. For [`AffinityPropagation`](generated/sklearn.cluster.AffinityPropagation.html#sklearn.cluster.AffinityPropagation "sklearn.cluster.AffinityPropagation"), [`SpectralClustering`](generated/sklearn.cluster.SpectralClustering.html#sklearn.cluster.SpectralClustering "sklearn.cluster.SpectralClustering")
and [`DBSCAN`](generated/sklearn.cluster.DBSCAN.html#sklearn.cluster.DBSCAN "sklearn.cluster.DBSCAN") one can also input similarity matrices of shape
`(n_samples, n_samples)`. These can be obtained from the functions
in the [`sklearn.metrics.pairwise`](../api/sklearn.metrics.html#module-sklearn.metrics.pairwise "sklearn.metrics.pairwise") module.

## 2.3.1. Overview of clustering methods[#](#overview-of-clustering-methods "Link to this heading")
...
A comparison of the clustering algorithms in scikit-learn[#](#id24 "Link to this image")
...
## 2.3.2. K-means[#](#k-means "Link to this heading")
...
### 2.3.2.1. Low-level parallelism[#](#low-level-parallelism "Link to this heading")
...
### 2.3.2.2. Mini Batch K-Means[#](#mini-batch-k-means "Link to this heading")
...
## 2.3.3. Affinity Propagation[#](#affinity-propagation "Link to this heading")
...
Algorithm description[#](#algorithm-description "Link to this dropdown")
...
## 2.3.4. Mean Shift[#](#mean-shift "Link to this heading")
...
## 2.3.5. Spectral clustering[#](#spectral-clustering "Link to this heading")
...
### 2.3.5.1. Different label assignment strategies[#](#different-label-assignment-strategies "Link to this heading")
...
| --- | --- | --- |
| [coin_kmeans](../auto_examples/cluster/plot_coin_segmentation.html) | [coin_discretize](../auto_examples/cluster/plot_coin_segmentation.html) | [coin_cluster_qr](../auto_examples/cluster/plot_coin_segmentation.html) |
...
### 2.3.5.2. Spectral Clustering Graphs[#](#spectral-clustering-graphs "Link to this heading")
...
## 2.3.6. Hierarchical clustering[#](#hierarchical-clustering "Link to this heading")
...
The [`FeatureAgglomeration`](generated/sklearn.cluster.FeatureAgglomeration.html#sklearn.cluster.FeatureAgglomeration "sklearn.cluster.FeatureAgglomeration") uses agglomerative clustering to
...
[Unsupervised dimensionality reduction](unsupervised_reduction.html#data-reduction).

### 2.3.6.1. Different linkage type: Ward, complete, average, and single linkage[#](#different-linkage-type-ward-complete-average-and-single-linkage "Link to this heading")
...
### 2.3.6.2. Visualization of cluster hierarchy[#](#visualization-of-cluster-hierarchy "Link to this heading")
...
### 2.3.6.3. Adding connectivity constraints[#](#adding-connectivity-constraints "Link to this heading")
...
### 2.3.6.4. Varying the metric[#](#varying-the-metric "Link to this heading")
...
[![../_images/sphx_glr_plot_agglomerative_clustering_metrics_005.png](../_images/sphx_glr_plot_agglomerative_clustering_metrics_005.png)](../auto_examples/cluster/plot_agglomerative_clustering_metrics.html)
[![../_images/sphx_glr_plot_agglomerative_clustering_metrics_006.png](../_images/sphx_glr_plot_agglomerative_clustering_metrics_006.png)](../auto_examples/cluster/plot_agglomerative_clustering_metrics.html)
[![../_images/sphx_glr_plot_agglomerative_clustering_metrics_007.png](../_images/sphx_glr_plot_agglomerative_clustering_metrics_007.png)](../auto_examples/cluster/plot_agglomerative_clustering_metrics.html)
...
### 2.3.6.5. Bisecting K-Means[#](#bisecting-k-means "Link to this heading")
...
* [“A Comparison of Document Clustering Techniques”](http://www.philippe-fournier-viger.com/spmf/bisectingkmeans.pdf) Michael
...
## 2.3.7. DBSCAN[#](#dbscan "Link to this heading")
...
Implementation[#](#implementation "Link to this dropdown")
...
Memory consumption for large sample sizes[#](#memory-consumption-for-large-sample-sizes "Link to this dropdown")
...
## 2.3.8. HDBSCAN[#](#hdbscan "Link to this heading")
...
### 2.3.8.1. Mutual Reachability Graph[#](#mutual-reachability-graph "Link to this heading")
...
### 2.3.8.2. Hierarchical Clustering[#](#id11 "Link to this heading")
...
## 2.3.9. OPTICS[#](#optics "Link to this heading")
...
Comparison with DBSCAN[#](#comparison-with-dbscan "Link to this dropdown")
...
Computational Complexity[#](#computational-complexity "Link to this dropdown")
...
## 2.3.10. BIRCH[#](#birch "Link to this heading")
...
Algorithm description[#](#algorithm-description-2 "Link to this dropdown")
...
BIRCH or MiniBatchKMeans?[#](#birch-or-minibatchkmeans? "Link to this dropdown")
...
How to use partial\_fit?[#](#how-to-use-partial_fit? "Link to this dropdown")
...
## 2.3.11. Clustering performance evaluation[#](#clustering-performance-evaluation "Link to this heading")
...
### 2.3.11.1. Rand index[#](#rand-index "Link to this heading")
...
### 2.3.11.2. Mutual Information based scores[#](#mutual-information-based-scores "Link to this heading")
...
Mathematical formulation[#](#mathematical-formulation-2 "Link to this dropdown")
...
* Strehl, Alexander, and Joydeep Ghosh (2002). “Cluster ensembles - a
  ...
  Machine Learning Research 3: 583-617. [doi:10.1162/153244303321897735](http://strehl.com/download/strehl-jmlr02.pdf).
...
### 2.3.11.3. Homogeneity, completeness and V-measure[#](#homogeneity-completeness-and-v-measure "Link to this heading")
...
Mathematical formulation[#](#mathematical-formulation-3 "Link to this dropdown")
...
[Identification and Characterization of Events in Social Media](http://www.cs.columbia.edu/~hila/hila-thesis-distributed.pdf), Hila
Becker, PhD Thesis.

### 2.3.11.4. Fowlkes-Mallows scores[#](#fowlkes-mallows-scores "Link to this heading")
...
References[#](#references-11 "Link to this dropdown")
...
### 2.3.11.5. Silhouette Coefficient[#](#silhouette-coefficient "Link to this heading")
...
References[#](#references-12 "Link to this dropdown")

* Peter J. Rousseeuw (1987). [“Silhouettes: a Graphical Aid to the
  Interpretation and Validation of Cluster Analysis”](https://doi.org/10.1016/0377-0427(87)90125-7).
  Computational and Applied Mathematics 20: 53-65.

### 2.3.11.6. Calinski-Harabasz Index[#](#calinski-harabasz-index "Link to this heading")
...
Mathematical formulation[#](#mathematical-formulation-4 "Link to this dropdown")
...
References[#](#references-13 "Link to this dropdown")
...
### 2.3.11.7. Davies-Bouldin Index[#](#davies-bouldin-index "Link to this heading")
...
Mathematical formulation[#](#mathematical-formulation-5 "Link to this dropdown")
...
References[#](#references-14 "Link to this dropdown")
...
### 2.3.11.8. Contingency Matrix[#](#contingency-matrix "Link to this heading")
...
References[#](#references-15 "Link to this dropdown")

* [Wikipedia entry for contingency matrix](https://en.wikipedia.org/wiki/Contingency_table)

### 2.3.11.9. Pair Confusion Matrix[#](#pair-confusion-matrix "Link to this heading")
...
References[#](#references-16 "Link to this dropdown")
...
2.2. Manifold learning](manifold.html "previous page")
[next

2.4. Biclustering](biclustering.html "next page")

On this page

* [2.3.1. Overview of clustering methods](#overview-of-clustering-methods)
* [2.3.2. K-means](#k-means)
  + [2.3.2.1. Low-level parallelism](#low-level-parallelism)
  + [2.3.2.2. Mini Batch K-Means](#mini-batch-k-means)
* [2.3.3. Affinity Propagation](#affinity-propagation)
* [2.3.4. Mean Shift](#mean-shift)
* [2.3.5. Spectral clustering](#spectral-clustering)
  + [2.3.5.1. Different label assignment strategies](#different-label-assignment-strategies)
  + [2.3.5.2. Spectral Clustering Graphs](#spectral-clustering-graphs)
* [2.3.6. Hierarchical clustering](#hierarchical-clustering)
  + [2.3.6.1. Different linkage type: Ward, complete, average, and single linkage](#different-linkage-type-ward-complete-average-and-single-linkage)
  + [2.3.6.2. Visualization of cluster hierarchy](#visualization-of-cluster-hierarchy)
  + [2.3.6.3. Adding connectivity constraints](#adding-connectivity-constraints)
  + [2.3.6.4. Varying the metric](#varying-the-metric)
  + [2.3.6.5. Bisecting K-Means](#bisecting-k-means)
* [2.3.7. DBSCAN](#dbscan)
* [2.3.8. HDBSCAN](#hdbscan)
  + [2.3.8.1. Mutual Reachability Graph](#mutual-reachability-graph)
  + [2.3.8.2. Hierarchical Clustering](#id11)
* [2.3.9. OPTICS](#optics)
* [2.3.10. BIRCH](#birch)
* [2.3.11. Clustering performance evaluation](#clustering-performance-evaluation)
  + [2.3.11.1. Rand index](#rand-index)
  + [2.3.11.2. Mutual Information based scores](#mutual-information-based-scores)
  + [2.3.11.3. Homogeneity, completeness and V-measure](#homogeneity-completeness-and-v-measure)
  + [2.3.11.4. Fowlkes-Mallows scores](#fowlkes-mallows-scores)
  + [2.3.11.5. Silhouette Coefficient](#silhouette-coefficient)
  + [2.3.11.6. Calinski-Harabasz Index](#calinski-harabasz-index)
  + [2.3.11.7. Davies-Bouldin Index](#davies-bouldin-index)
  + [2.3.11.8. Contingency Matrix](#contingency-matrix)
  + [2.3.11.9. Pair Confusion Matrix](#pair-confusion-matrix)

### This Page

* [Show Source](../_sources/modules/clustering.rst.txt)