...
Source URL: https://scikit-learn.org/stable/datasets.html
...
described in the [Toy datasets](datasets/toy_dataset.html#toy-datasets) section.

**The dataset fetchers.** They can be used to download and load larger datasets,
described in the [Real world datasets](datasets/real_world.html#real-world-datasets) section.

Both loaders and fetchers functions return a [`Bunch`](modules/generated/sklearn.utils.Bunch.html#sklearn.utils.Bunch "sklearn.utils.Bunch")
...
For more information about Bunch object, see [`Bunch`](modules/generated/sklearn.utils.Bunch.html#sklearn.utils.Bunch "sklearn.utils.Bunch").
...
synthetic datasets, described in the [Generated datasets](datasets/sample_generators.html#sample-generators) section.
...
formats or from other locations, described in the [Loading other datasets](datasets/loading_other_datasets.html#loading-other-datasets)
section.
...
7.9. Transforming the prediction target (`y`)](modules/preprocessing_targets.html "previous page")
[next

8.1. Toy datasets](datasets/toy_dataset.html "next page")

### This Page

* [Show Source](_sources/datasets.rst.txt)