...
## 3.1.1. Computing cross-validated metrics[#](#computing-cross-validated-metrics "Link to this heading")
...
Data transformation with held-out data[#](#data-transformation-with-held-out-data "Link to this dropdown")
...
### 3.1.1.1. The cross\_validate function and multiple metric evaluation[#](#the-cross-validate-function-and-multiple-metric-evaluation "Link to this heading")
...
### 3.1.1.2. Obtaining predictions by cross-validation[#](#obtaining-predictions-by-cross-validation "Link to this heading")
...
## 3.1.2. Cross validation iterators[#](#cross-validation-iterators "Link to this heading")
...
### 3.1.2.1. Cross-validation iterators for i.i.d. data[#](#cross-validation-iterators-for-i-i-d-data "Link to this heading")
...
#### 3.1.2.1.1. K-fold[#](#k-fold "Link to this heading")
...
#### 3.1.2.1.2. Repeated K-Fold[#](#repeated-k-fold "Link to this heading")
...
#### 3.1.2.1.3. Leave One Out (LOO)[#](#leave-one-out-loo "Link to this heading")
...
#### 3.1.2.1.4. Leave P Out (LPO)[#](#leave-p-out-lpo "Link to this heading")
...
#### 3.1.2.1.5. Random permutations cross-validation a.k.a. Shuffle & Split[#](#random-permutations-cross-validation-a-k-a-shuffle-split "Link to this heading")
...
### 3.1.2.2. Cross-validation iterators with stratification based on class labels[#](#cross-validation-iterators-with-stratification-based-on-class-labels "Link to this heading")
...
#### 3.1.2.2.1. Stratified K-fold[#](#stratified-k-fold "Link to this heading")
...
#### 3.1.2.2.2. Stratified Shuffle Split[#](#stratified-shuffle-split "Link to this heading")
...
### 3.1.2.3. Predefined fold-splits / Validation-sets[#](#predefined-fold-splits-validation-sets "Link to this heading")
...
### 3.1.2.4. Cross-validation iterators for grouped data[#](#cross-validation-iterators-for-grouped-data "Link to this heading")
...
#### 3.1.2.4.1. Group K-fold[#](#group-k-fold "Link to this heading")
...
#### 3.1.2.4.2. StratifiedGroupKFold[#](#stratifiedgroupkfold "Link to this heading")
...
Implementation notes[#](#implementation-notes "Link to this dropdown")
...
#### 3.1.2.4.3. Leave One Group Out[#](#leave-one-group-out "Link to this heading")
...
#### 3.1.2.4.4. Leave P Groups Out[#](#leave-p-groups-out "Link to this heading")
...
#### 3.1.2.4.5. Group Shuffle Split[#](#group-shuffle-split "Link to this heading")
...
### 3.1.2.5. Using cross-validation iterators to split train and test[#](#using-cross-validation-iterators-to-split-train-and-test "Link to this heading")
...
### 3.1.2.6. Cross validation of time series data[#](#cross-validation-of-time-series-data "Link to this heading")
...
#### 3.1.2.6.1. Time Series Split[#](#time-series-split "Link to this heading")
...
## 3.1.3. A note on shuffling[#](#a-note-on-shuffling "Link to this heading")
...
## 3.1.4. Cross validation and model selection[#](#cross-validation-and-model-selection "Link to this heading")
...
## 3.1.5. Permutation test score[#](#permutation-test-score "Link to this heading")
...
3. Model selection and evaluation](../model_selection.html "previous page")
[next

3.2. Tuning the hyper-parameters of an estimator](grid_search.html "next page")

On this page

* [3.1.1. Computing cross-validated metrics](#computing-cross-validated-metrics)
  + [3.1.1.1. The cross\_validate function and multiple metric evaluation](#the-cross-validate-function-and-multiple-metric-evaluation)
  + [3.1.1.2. Obtaining predictions by cross-validation](#obtaining-predictions-by-cross-validation)
* [3.1.2. Cross validation iterators](#cross-validation-iterators)
  + [3.1.2.1. Cross-validation iterators for i.i.d. data](#cross-validation-iterators-for-i-i-d-data)
    - [3.1.2.1.1. K-fold](#k-fold)
    - [3.1.2.1.2. Repeated K-Fold](#repeated-k-fold)
    - [3.1.2.1.3. Leave One Out (LOO)](#leave-one-out-loo)
    - [3.1.2.1.4. Leave P Out (LPO)](#leave-p-out-lpo)
    - [3.1.2.1.5. Random permutations cross-validation a.k.a. Shuffle & Split](#random-permutations-cross-validation-a-k-a-shuffle-split)
  + [3.1.2.2. Cross-validation iterators with stratification based on class labels](#cross-validation-iterators-with-stratification-based-on-class-labels)
    - [3.1.2.2.1. Stratified K-fold](#stratified-k-fold)
    - [3.1.2.2.2. Stratified Shuffle Split](#stratified-shuffle-split)
  + [3.1.2.3. Predefined fold-splits / Validation-sets](#predefined-fold-splits-validation-sets)
  + [3.1.2.4. Cross-validation iterators for grouped data](#cross-validation-iterators-for-grouped-data)
    - [3.1.2.4.1. Group K-fold](#group-k-fold)
    - [3.1.2.4.2. StratifiedGroupKFold](#stratifiedgroupkfold)
    - [3.1.2.4.3. Leave One Group Out](#leave-one-group-out)
    - [3.1.2.4.4. Leave P Groups Out](#leave-p-groups-out)
    - [3.1.2.4.5. Group Shuffle Split](#group-shuffle-split)
  + [3.1.2.5. Using cross-validation iterators to split train and test](#using-cross-validation-iterators-to-split-train-and-test)
  + [3.1.2.6. Cross validation of time series data](#cross-validation-of-time-series-data)
    - [3.1.2.6.1. Time Series Split](#time-series-split)
* [3.1.3. A note on shuffling](#a-note-on-shuffling)
* [3.1.4. Cross validation and model selection](#cross-validation-and-model-selection)
* [3.1.5. Permutation test score](#permutation-test-score)

### This Page

* [Show Source](../_sources/modules/cross_validation.rst.txt)