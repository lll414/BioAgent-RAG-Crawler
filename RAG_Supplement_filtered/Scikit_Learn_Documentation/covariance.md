...
Source URL: https://scikit-learn.org/stable/modules/covariance.html
...
[`sklearn.covariance`](../api/sklearn.covariance.html#module-sklearn.covariance "sklearn.covariance") package provides tools for accurately estimating
a population’s covariance matrix under various settings.

We assume that the observations are independent and identically
distributed (i.i.d.).

## 2.6.1. Empirical covariance[#](#empirical-covariance "Link to this heading")
...
[`empirical_covariance`](generated/sklearn.covariance.empirical_covariance.html#sklearn.covariance.empirical_covariance "sklearn.covariance.empirical_covariance") function of the package, or by fitting an
[`EmpiricalCovariance`](generated/sklearn.covariance.EmpiricalCovariance.html#sklearn.covariance.EmpiricalCovariance "sklearn.covariance.EmpiricalCovariance") object to the data sample with the
[`EmpiricalCovariance.fit`](generated/sklearn.covariance.EmpiricalCovariance.html#sklearn.covariance.EmpiricalCovariance.fit "sklearn.covariance.EmpiricalCovariance.fit") method. Be careful that results depend
...
* See [Shrinkage covariance estimation: LedoitWolf vs OAS and max-likelihood](../auto_examples/covariance/plot_covariance_estimation.html#sphx-glr-auto-examples-covariance-plot-covariance-estimation-py) for
  an example on how to fit an [`EmpiricalCovariance`](generated/sklearn.covariance.EmpiricalCovariance.html#sklearn.covariance.EmpiricalCovariance "sklearn.covariance.EmpiricalCovariance") object to data.

## 2.6.2. Shrunk Covariance[#](#shrunk-covariance "Link to this heading")

### 2.6.2.1. Basic shrinkage[#](#basic-shrinkage "Link to this heading")
...
the [`shrunk_covariance`](generated/sklearn.covariance.shrunk_covariance.html#sklearn.covariance.shrunk_covariance "sklearn.covariance.shrunk_covariance") method. Also, a shrunk estimator of the
covariance can be fitted to data with a [`ShrunkCovariance`](generated/sklearn.covariance.ShrunkCovariance.html#sklearn.covariance.ShrunkCovariance "sklearn.covariance.ShrunkCovariance") object
and its [`ShrunkCovariance.fit`](generated/sklearn.covariance.ShrunkCovariance.html#sklearn.covariance.ShrunkCovariance.fit "sklearn.covariance.ShrunkCovariance.fit") method. Again, results depend on
...
boils down to a simple convex transformation : \(\Sigma\_{\rm
...
* See [Shrinkage covariance estimation: LedoitWolf vs OAS and max-likelihood](../auto_examples/covariance/plot_covariance_estimation.html#sphx-glr-auto-examples-covariance-plot-covariance-estimation-py) for
  an example on how to fit a [`ShrunkCovariance`](generated/sklearn.covariance.ShrunkCovariance.html#sklearn.covariance.ShrunkCovariance "sklearn.covariance.ShrunkCovariance") object to data.

### 2.6.2.2. Ledoit-Wolf shrinkage[#](#ledoit-wolf-shrinkage "Link to this heading")

In their 2004 paper [[1]](#id3), O. Ledoit and M. Wolf propose a formula
...
a sample with the [`ledoit_wolf`](generated/sklearn.covariance.ledoit_wolf.html#sklearn.covariance.ledoit_wolf "sklearn.covariance.ledoit_wolf") function of the
[`sklearn.covariance`](../api/sklearn.covariance.html#module-sklearn.covariance "sklearn.covariance") package, or it can be otherwise obtained by
fitting a [`LedoitWolf`](generated/sklearn.covariance.LedoitWolf.html#sklearn.covariance.LedoitWolf "sklearn.covariance.LedoitWolf") object to the same sample.
...
* See [Shrinkage covariance estimation: LedoitWolf vs OAS and max-likelihood](../auto_examples/covariance/plot_covariance_estimation.html#sphx-glr-auto-examples-covariance-plot-covariance-estimation-py) for
  an example on how to fit a [`LedoitWolf`](generated/sklearn.covariance.LedoitWolf.html#sklearn.covariance.LedoitWolf "sklearn.covariance.LedoitWolf") object to data and
...
### 2.6.2.3. Oracle Approximating Shrinkage[#](#oracle-approximating-shrinkage "Link to this heading")

Under the assumption that the data are Gaussian distributed, Chen et
al. [[2]](#id6) derived a formula aimed at choosing a shrinkage coefficient that
...
with the [`oas`](generated/oas-function.html#sklearn.covariance.oas "sklearn.covariance.oas") function of the [`sklearn.covariance`](../api/sklearn.covariance.html#module-sklearn.covariance "sklearn.covariance")
package, or it can be otherwise obtained by fitting an [`OAS`](generated/sklearn.covariance.OAS.html#sklearn.covariance.OAS "sklearn.covariance.OAS")
...
choices of Ledoit-Wolf and OAS estimators[#](#id13 "Link to this image")
...
IEEE Transactions on Signal Processing, 58(10), 5016-5029, 2010.](https://arxiv.org/abs/0907.4698)

Examples

* See [Shrinkage covariance estimation: LedoitWolf vs OAS and max-likelihood](../auto_examples/covariance/plot_covariance_estimation.html#sphx-glr-auto-examples-covariance-plot-covariance-estimation-py) for
  an example on how to fit an [`OAS`](generated/sklearn.covariance.OAS.html#sklearn.covariance.OAS "sklearn.covariance.OAS") object to data.
* See [Ledoit-Wolf vs OAS estimation](../auto_examples/covariance/plot_lw_vs_oas.html#sphx-glr-auto-examples-covariance-plot-lw-vs-oas-py) to visualize the
  Mean Squared Error difference between a [`LedoitWolf`](generated/sklearn.covariance.LedoitWolf.html#sklearn.covariance.LedoitWolf "sklearn.covariance.LedoitWolf") and
  an [`OAS`](generated/sklearn.covariance.OAS.html#sklearn.covariance.OAS "sklearn.covariance.OAS") estimator of the covariance.
...
## 2.6.3. Sparse inverse covariance[#](#sparse-inverse-covariance "Link to this heading")
...
The [`GraphicalLasso`](generated/sklearn.covariance.GraphicalLasso.html#sklearn.covariance.GraphicalLasso "sklearn.covariance.GraphicalLasso") estimator uses an l1 penalty to enforce sparsity on
the precision matrix: the higher its `alpha` parameter, the more sparse
the precision matrix. The corresponding [`GraphicalLassoCV`](generated/sklearn.covariance.GraphicalLassoCV.html#sklearn.covariance.GraphicalLassoCV "sklearn.covariance.GraphicalLassoCV") object uses
...
settings.*[#](#id14 "Link to this image")
...
* Recovery is easier from a correlation matrix than a covariance
  matrix: standardize your observations before running [`GraphicalLasso`](generated/sklearn.covariance.GraphicalLasso.html#sklearn.covariance.GraphicalLasso "sklearn.covariance.GraphicalLasso")
...
* Even if you are in favorable recovery conditions, the alpha
  ...
  [`GraphicalLassoCV`](generated/sklearn.covariance.GraphicalLassoCV.html#sklearn.covariance.GraphicalLassoCV "sklearn.covariance.GraphicalLassoCV") object) will lead to selecting too many edges.
...
* [Sparse inverse covariance estimation](../auto_examples/covariance/plot_sparse_cov.html#sphx-glr-auto-examples-covariance-plot-sparse-cov-py): example on synthetic
  data showing some recovery of a structure, and comparing to other
  covariance estimators.
* [Visualizing the stock market structure](../auto_examples/applications/plot_stock_market.html#sphx-glr-auto-examples-applications-plot-stock-market-py): example on real
  stock market data, finding which symbols are most linked.

References

* Friedman et al, [“Sparse inverse covariance estimation with the
  graphical lasso”](https://biostatistics.oxfordjournals.org/content/9/3/432.short),
  Biostatistics 9, pp 432, 2008

## 2.6.4. Robust Covariance Estimation[#](#robust-covariance-estimation "Link to this heading")
...
the Minimum Covariance Determinant [[3]](#id11).

### 2.6.4.1. Minimum Covariance Determinant[#](#minimum-covariance-determinant "Link to this heading")

The Minimum Covariance Determinant estimator is a robust estimator of
a data set’s covariance introduced by P.J. Rousseeuw in [[3]](#id11). The idea
...
Rousseeuw and Van Driessen [[4]](#id12) developed the FastMCD algorithm in order
...
attributes of a [`MinCovDet`](generated/sklearn.covariance.MinCovDet.html#sklearn.covariance.MinCovDet "sklearn.covariance.MinCovDet") robust covariance estimator object.
...
* See [Robust vs Empirical covariance estimate](../auto_examples/covariance/plot_robust_vs_empirical_covariance.html#sphx-glr-auto-examples-covariance-plot-robust-vs-empirical-covariance-py) for
  an example on how to fit a [`MinCovDet`](generated/sklearn.covariance.MinCovDet.html#sklearn.covariance.MinCovDet "sklearn.covariance.MinCovDet") object to data and see how
  the estimate remains accurate despite the presence of outliers.
* See [Robust covariance estimation and Mahalanobis distances relevance](../auto_examples/covariance/plot_mahalanobis_distances.html#sphx-glr-auto-examples-covariance-plot-mahalanobis-distances-py) to
  visualize the difference between [`EmpiricalCovariance`](generated/sklearn.covariance.EmpiricalCovariance.html#sklearn.covariance.EmpiricalCovariance "sklearn.covariance.EmpiricalCovariance") and
  [`MinCovDet`](generated/sklearn.covariance.MinCovDet.html#sklearn.covariance.MinCovDet "sklearn.covariance.MinCovDet") covariance estimators in terms of Mahalanobis distance
...
| --- | --- |
| [robust_vs_emp](../auto_examples/covariance/plot_robust_vs_empirical_covariance.html) | [mahalanobis](../auto_examples/covariance/plot_mahalanobis_distances.html) |

[previous

2.5. Decomposing signals in components (matrix factorization problems)](decomposition.html "previous page")
[next

2.7. Novelty and Outlier Detection](outlier_detection.html "next page")

On this page

* [2.6.1. Empirical covariance](#empirical-covariance)
* [2.6.2. Shrunk Covariance](#shrunk-covariance)
  + [2.6.2.1. Basic shrinkage](#basic-shrinkage)
  + [2.6.2.2. Ledoit-Wolf shrinkage](#ledoit-wolf-shrinkage)
  + [2.6.2.3. Oracle Approximating Shrinkage](#oracle-approximating-shrinkage)
* [2.6.3. Sparse inverse covariance](#sparse-inverse-covariance)
* [2.6.4. Robust Covariance Estimation](#robust-covariance-estimation)
  + [2.6.4.1. Minimum Covariance Determinant](#minimum-covariance-determinant)

### This Page

* [Show Source](../_sources/modules/covariance.rst.txt)