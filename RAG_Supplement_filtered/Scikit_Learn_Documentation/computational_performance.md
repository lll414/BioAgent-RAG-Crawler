...
Source URL: https://scikit-learn.org/stable/computing/computational_performance.html
...
## 9.2.1. Prediction Latency[#](#prediction-latency "Link to this heading")
...
### 9.2.1.1. Bulk versus Atomic mode[#](#bulk-versus-atomic-mode "Link to this heading")
...
[Prediction Latency](../auto_examples/applications/plot_prediction_latency.html#sphx-glr-auto-examples-applications-plot-prediction-latency-py). This should give
you an estimate of the order of magnitude of the prediction latency.

### 9.2.1.2. Configuring Scikit-learn for reduced validation overhead[#](#configuring-scikit-learn-for-reduced-validation-overhead "Link to this heading")
...
scikit-learn, or configure it in Python with [`set_config`](../modules/generated/sklearn.set_config.html#sklearn.set_config "sklearn.set_config").
For more control than these global settings, a [`config_context`](../modules/generated/sklearn.config_context.html#sklearn.config_context "sklearn.config_context")
...
[`assert_all_finite`](../modules/generated/sklearn.utils.assert_all_finite.html#sklearn.utils.assert_all_finite "sklearn.utils.assert_all_finite") within the context.

### 9.2.1.3. Influence of the Number of Features[#](#influence-of-the-number-of-features "Link to this heading")
...
### 9.2.1.4. Influence of the Input Data Representation[#](#influence-of-the-input-data-representation "Link to this heading")
...
a sparse ([CSR or CSC](https://docs.scipy.org/doc/scipy/reference/sparse.html))
...
matrix formats [documentation](https://docs.scipy.org/doc/scipy/reference/sparse.html)
...
### 9.2.1.5. Influence of the Model Complexity[#](#influence-of-the-model-complexity "Link to this heading")
...
For [`sklearn.linear_model`](../api/sklearn.linear_model.html#module-sklearn.linear_model "sklearn.linear_model") (e.g. Lasso, ElasticNet,
...
[`SGDClassifier`](../modules/generated/sklearn.linear_model.SGDClassifier.html#sklearn.linear_model.SGDClassifier "sklearn.linear_model.SGDClassifier") with the
...
For the [`sklearn.svm`](../api/sklearn.svm.html#module-sklearn.svm "sklearn.svm") family of algorithms with a non-linear kernel,
...
[`NuSVR`](../modules/generated/sklearn.svm.NuSVR.html#sklearn.svm.NuSVR "sklearn.svm.NuSVR") was used to influence the number of
support vectors.
...
For [`sklearn.ensemble`](../api/sklearn.ensemble.html#module-sklearn.ensemble "sklearn.ensemble") of trees (e.g. RandomForest, GBT,
...
[`GradientBoostingRegressor`](../modules/generated/sklearn.ensemble.GradientBoostingRegressor.html#sklearn.ensemble.GradientBoostingRegressor "sklearn.ensemble.GradientBoostingRegressor").
...
### 9.2.1.6. Feature Extraction Latency[#](#feature-extraction-latency "Link to this heading")
...
## 9.2.2. Prediction Throughput[#](#prediction-throughput "Link to this heading")
...
[Prediction Latency](../auto_examples/applications/plot_prediction_latency.html#sphx-glr-auto-examples-applications-plot-prediction-latency-py) example that measures
...
[GIL](https://wiki.python.org/moin/GlobalInterpreterLock)) that share the
...
## 9.2.3. Tips and Tricks[#](#tips-and-tricks "Link to this heading")

### 9.2.3.1. Linear algebra libraries[#](#linear-algebra-libraries "Link to this heading")
...
Basically, you ought to make sure that Numpy is built using an optimized [BLAS](https://en.wikipedia.org/wiki/Basic_Linear_Algebra_Subprograms) /
...
More information can be found on the [NumPy install page](https://numpy.org/install/)
and in this
[blog post](https://danielnouri.org/notes/2012/12/19/libblas-and-liblapack-issues-and-speed,-with-scipy-and-ubuntu/)
from Daniel Nouri which has some nice step by step install instructions for
Debian / Ubuntu.

### 9.2.3.2. Limiting Working Memory[#](#limiting-working-memory "Link to this heading")
...
working memory (defaulting to 1GB) using [`set_config`](../modules/generated/sklearn.set_config.html#sklearn.set_config "sklearn.set_config") or
[`config_context`](../modules/generated/sklearn.config_context.html#sklearn.config_context "sklearn.config_context"). The following suggests to limit temporary working
memory to 128 MiB:
...
[`pairwise_distances_chunked`](../modules/generated/sklearn.metrics.pairwise_distances_chunked.html#sklearn.metrics.pairwise_distances_chunked "sklearn.metrics.pairwise_distances_chunked"), which facilitates computing
row-wise reductions of a pairwise distance matrix.

### 9.2.3.3. Model Compression[#](#model-compression "Link to this heading")
...
A typical [benchmark](https://github.com/scikit-learn/scikit-learn/blob/main/benchmarks/bench_sparsify.py)
...
### 9.2.3.4. Model Reshaping[#](#model-reshaping "Link to this heading")
...
### 9.2.3.5. Links[#](#links "Link to this heading")
...
9.1. Strategies to scale computationally: bigger data](scaling_strategies.html "previous page")
[next

9.3. Parallelism, resource management, and configuration](parallelism.html "next page")

On this page

* [9.2.1. Prediction Latency](#prediction-latency)
  + [9.2.1.1. Bulk versus Atomic mode](#bulk-versus-atomic-mode)
  + [9.2.1.2. Configuring Scikit-learn for reduced validation overhead](#configuring-scikit-learn-for-reduced-validation-overhead)
  + [9.2.1.3. Influence of the Number of Features](#influence-of-the-number-of-features)
  + [9.2.1.4. Influence of the Input Data Representation](#influence-of-the-input-data-representation)
  + [9.2.1.5. Influence of the Model Complexity](#influence-of-the-model-complexity)
  + [9.2.1.6. Feature Extraction Latency](#feature-extraction-latency)
* [9.2.2. Prediction Throughput](#prediction-throughput)
* [9.2.3. Tips and Tricks](#tips-and-tricks)
  + [9.2.3.1. Linear algebra libraries](#linear-algebra-libraries)
  + [9.2.3.2. Limiting Working Memory](#limiting-working-memory)
  + [9.2.3.3. Model Compression](#model-compression)
  + [9.2.3.4. Model Reshaping](#model-reshaping)
  + [9.2.3.5. Links](#links)

### This Page

* [Show Source](../_sources/computing/computational_performance.rst.txt)