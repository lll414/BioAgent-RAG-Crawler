Source URL: https://bioconductor.org/books/release/OSTA/pages/ind-image-analysis.html
Date Scraped: 2025-12-15

---

1. [Platform-independent analyses](https://bioconductor.org/books/release/OSTA/pages/ind-normalization.html)
2. [32  Image analysis](https://bioconductor.org/books/release/OSTA/pages/ind-image-analysis.html)
...
![](../images/pyramidal_structure.png)
...
![](../images/imageTCGA_shiny_OV.png)

Figure 32.3: Filtering images in imageTCGA Shiny application

You can generate R code to download the selected images to your local machine by clicking the blue “Generate R Code” button. This utilizes the *[GenomicDataCommons](https://bioconductor.org/packages/3.22/GenomicDataCommons)* package.

In the example below, Ovarian Cancer images have been selected:

![](../images/imageTCGA_shiny_OV_Rcode.png)
...
![](../images/imageTCGA_shiny_worldmap_GBM.png)
