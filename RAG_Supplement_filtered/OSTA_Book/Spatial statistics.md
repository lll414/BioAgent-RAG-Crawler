Source URL: https://bioconductor.org/books/release/OSTA/pages/ind-spatial-statistics.html
Date Scraped: 2025-12-15

---

1. [Platform-independent analyses](https://bioconductor.org/books/release/OSTA/pages/ind-normalization.html)
2. [31  Spatial statistics](https://bioconductor.org/books/release/OSTA/pages/ind-spatial-statistics.html)
...
![](ind-spatial-statistics_files/figure-html/weight_matrix-1.png)
...
![](ind-spatial-statistics_files/figure-html/plot_moran_genes-1.png)
...
![](ind-spatial-statistics_files/figure-html/local_moran-1.png)

Statistical interpretation of autocorrelation
...
![](ind-spatial-statistics_files/figure-html/local_moran_pvals-1.png)
...
![](ind-spatial-statistics_files/figure-html/local_lees_l-1.png)
...
![](ind-spatial-statistics_files/figure-html/clustering-1.png)
...
![](ind-spatial-statistics_files/figure-html/plot_object-1.png)

### 31.3.1 Intensity

The first property to assess in a point pattern is the intensity. For a window W and points x, the average intensity λ¯ is defined as the number of points n(x) divided by the area of the window |W|:
...
![](ind-spatial-statistics_files/figure-html/estimating_intensity-1.png)
...
![](ind-spatial-statistics_files/figure-html/unnamed-chunk-3-1.png)

We note that all cell types, ductal carcinoma in situ 1 (DCIS 1), ductal carcinoma in situ 2 (DCIS 2), and invasive tumor cells show a clear interaction among themselves. DCIS 1 and invasive tumor cells show spacing, meaning there are fewer invasive tumor cells found in DCIS 1 than expect under complete spatial randomness (CSR). However, DCIS 2 and invasive tumor cells show a distribution that is completely spatially random in a µ500µm r-neighborhood.
...
![](ind-spatial-statistics_files/figure-html/nndist-1.png)
...
![](ind-spatial-statistics_files/figure-html/localK_1-1.png)
...
![](ind-spatial-statistics_files/figure-html/localK_2-1.png)

The LISA Ripley’s K are colored by their value at r=700. We note that the LISA Ripley’s K gives two populations of curves. Those curves that increase at radii µr<500µm above the CSR line indicated in gray and the other curves that remain either below the gray CSR line or increase after µr>500µm.
